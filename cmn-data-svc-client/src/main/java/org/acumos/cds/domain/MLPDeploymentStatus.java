...
public class MLPDeploymentStatus implements MLPEntity, Serializable {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (!(that instanceof MLPDeploymentStatus))
			return false;
		MLPDeploymentStatus thatObj = (MLPDeploymentStatus) that;
